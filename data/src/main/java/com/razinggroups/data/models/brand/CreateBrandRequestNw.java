...
public class CreateBrandRequestNw {
    ...
    public CreateBrandRequestNw(String brandName, String brandCompany, String brandDivision, String divisionMail, String divisionMobile, String brandEmail, String brandMobile, String brandStreet, String brandCity, String brandCode, String brandCountry) {
    ...
    public CreateBrandRequestNw(String id, String brandName, String brandCompany, String brandDivision, String divisionMail, String divisionMobile, String brandEmail, String brandMobile, String brandStreet, String brandCity, String brandCode, String brandCountry) {
        this.id = id;
        this.brandName = brandName;
        this.brandCompany = brandCompany;
        this.brandDivision = brandDivision;
