...
public class CreateBrandRequest {
    ...
    public CreateBrandRequest(String brandName, String brandCompany, String brandDivision, String divisionMail, String divisionMobile, String brandEmail, String brandMobile, String brandStreet, String brandCity, String brandCode, String brandCountry) {
    ...
    public CreateBrandRequest(String id, String brandName, String brandCompany, String brandDivision, String divisionMail, String divisionMobile, String brandEmail, String brandMobile, String brandStreet, String brandCity, String brandCode, String brandCountry) {
        this.id = id;
        this.brandName = brandName;
        this.brandCompany = brandCompany;
        this.brandDivision = brandDivision;
    ...
    public String toString() {
        return "CreateBrandRequest{" +
                ...
                ", divisionMail='" + divisionMail + '\'' +
                ", divisionMobile='" + divisionMobile + '\'' +
                ", brandEmail='" + brandEmail + '\'' +
                ", brandMobile='" + brandMobile + '\'' +
                ", brandStreet='" + brandStreet + '\'' +
                ", brandCity='" + brandCity + '\'' +
                ", brandCode='" + brandCode + '\'' +
