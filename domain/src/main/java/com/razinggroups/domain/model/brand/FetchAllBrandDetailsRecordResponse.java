...
public class FetchAllBrandDetailsRecordResponse {
    ...
    public FetchAllBrandDetailsRecordResponse(String id, String brandName, String brandCompany, String brandDivision, String divisionMail, String divisionMobile, String brandEmail, String brandMobile, String brandStreet, String brandCity, String brandCode, String brandCountry) {
        this.id = id;
    ...
    public FetchAllBrandDetailsRecordResponse() {
